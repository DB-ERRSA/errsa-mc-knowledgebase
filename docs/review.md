# ERRSA MC — Operational Review & Navigation

This page provides a single entry point to all operational documentation
for the ERRSA Minecraft server.

If you are reviewing, onboarding, or taking over responsibility,
start here.
...
## Authoritative documents (official)
...
These pages are used **as needed**, not read linearly.

- **[Getting Started](getting-started.md)**  
  Orientation, system overview, and safety rules.

- **[Permissions Model](standards/permissions.md)**  
  Detailed explanation of MAIN / ERRSA / STAFF tracks.

- **[Plugins](plugins/index.md)**  
  Per-plugin reference documentation.
...
## Review checklist (for handoff or audit)

You are ready to operate or take over the server if you can:

- Identify which document governs a given situation
- Trace a player from first join → survival
- Name the core operational plugins and their responsibilities
- Follow change control without improvising
...
This wiki explains **how the server works**.  
The official documents define **what you are allowed to do**.
